...
{
    private static final String URL_FORMAT_ID = "http://192.168.1.8:6969/%s/%d";
    private static final String URL_FORMAT_PAGE = "http://192.168.1.8:6969/%s/page?page=%s&pageSize=%s";
